...
new #[Title('Fakultas')] class extends Component {
...
<div>
    <x-header title="Fakultas" separator>
        <x-slot:actions>
    ...
    <x-modal wire:model="modal" title="Form Fakultas" box-class="w-full h-fit max-w-[600px]" without-trap-focus>
