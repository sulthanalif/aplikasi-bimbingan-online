...
new #[Title('Program Studi')] class extends Component {
    ...
    public function datas(): LengthAwarePaginator
    {
        return $this->pageModel->query()
            ...
            ->when($this->sortBy['column'] === 'faculty_name', function($query) {
                $query->orderBy('faculty_name', $this->sortBy['direction']);
            }, function($query) {
...
@script
    <script>
        ...
        $js('edit', (data) => {
            ...
            $wire.faculty_id = data.faculty_id;
            $wire.name = data.name;
...
<div>
    <x-header title="Program Studi" separator>
        <x-slot:actions>
    ...
    <x-modal wire:model="modal" title="Form Program Studi" box-class="w-full h-fit max-w-[600px]" without-trap-focus>
