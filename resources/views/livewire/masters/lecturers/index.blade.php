...
new #[Title('Dosen')] class extends Component {
...
<div>
    <x-header title="Dosen" separator>
        <x-slot:actions>
    ...
    <x-modal wire:model="modal" title="Form Dosen" box-class="w-full h-fit max-w-[600px]" without-trap-focus>
        <x-form wire:submit="save" no-separator>

            <div class="grid lg:grid-cols-2 gap-4">
                <div>
                    <x-input label="NIP" wire:model="nip" type="number" required />
                </div>
                <div>
